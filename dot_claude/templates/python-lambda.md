...
Terraform creates Lambdas with dummy code and `ignore_changes` on
`source_code_hash`. Actual code is deployed by the CI/CD pipeline via `aws
lambda update-function-code`, not by Terraform.

# Generated by Powerlevel10k configuration wizard on 2023-02-14 at 21:47 CET.
...
() {
  ...
  #typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|awsume|awless|make|terraform|tf|make|pulumi|terragrunt'
